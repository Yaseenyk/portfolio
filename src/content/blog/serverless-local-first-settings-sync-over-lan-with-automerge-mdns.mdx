...
The example below is a LAN-sync sidecar you can run alongside a desktop shell or embed in a Node service. It uses bonjour-service for mDNS/DNS-SD and net for TCP. The service is advertised with a shared docId, and peers initiate connections deterministically to prevent connection storms.
