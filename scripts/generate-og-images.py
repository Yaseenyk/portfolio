...
def image_brief(oai, title, hook):
    prompt = (
        ...
        "the article's core idea, expressed in flat geometric shapes. Be "
        "specific to THIS article — never a generic laptop, circuit board, or "
        "glowing cube, and never a realistic animal or character.\n"
